...
HD_PWD='C:/Users/ilyou/OneDrive/¹®¼­/GitHub/EEE3163-S4P/project_cpu/project_cpu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S4P.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S4P.tcl -notrace
