...
HD_PWD='C:/Users/ilyou/OneDrive/¹®¼­/GitHub/EEE3163-S4P/project_cpu/project_cpu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S4P.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S4P.tcl
